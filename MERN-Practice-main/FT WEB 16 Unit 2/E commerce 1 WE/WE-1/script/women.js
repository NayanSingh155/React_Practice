var womensData = [
  ...
  womensData.map(function(elem,index,array){
    ...
    var strikeoffprice =document.createElement("s");
    strikeoffprice.innerText=elem.strikedoffprice;
    var box3=document.createElement("div");
    box3.append(price,strikeoffprice);
    var cart=document.createElement("button");
    cart.innerText="Add to Cart";
    var wish=document.createElement("button");
    wish.innerText="Wishlist";
    var box4=document.createElement("div");
    box4.append(cart,wish);
    box1.append(img,name,box3,box4);
